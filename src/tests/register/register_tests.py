...
class testRegisterMethods(unittest.TestCase):
    ...
    def test_register_exists(self):
        oRegister = register.register(sName='Reg1', iWidth=10)
        self.assertEqual(oRegister.sName,'Reg1')

    def test_register_width(self):
        oRegister = register.register(sName='Reg1', iWidth=32)
    ...
    def test_register_map_entry(self):
        oRegister = register.register(sName='Register 1', iWidth=32)
